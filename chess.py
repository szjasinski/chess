from tkinter import *
import figure_normal_moves_functions as fnc
...
my_frame = Frame(root, width=500, height=500, bg=under_checkerboard_color)
...
white_pawn_white_bg_image = PhotoImage(file="chess_img/white_bg/white_pawn_white_bg.png")
white_rock_white_bg_image = PhotoImage(file="chess_img/white_bg/white_rock_white_bg.png")
white_knight_white_bg_image = PhotoImage(file="chess_img/white_bg/white_knight_white_bg.png")
white_bishop_white_bg_image = PhotoImage(file="chess_img/white_bg/white_bishop_white_bg.png")
white_king_white_bg_image = PhotoImage(file="chess_img/white_bg/white_king_white_bg.png")
white_queen_white_bg_image = PhotoImage(file="chess_img/white_bg/white_queen_white_bg.png")

white_pawn_grey_bg_image = PhotoImage(file="chess_img/grey_bg/white_pawn_grey_bg.png")
white_rock_grey_bg_image = PhotoImage(file="chess_img/grey_bg/white_rock_grey_bg.png")
white_knight_grey_bg_image = PhotoImage(file="chess_img/grey_bg/white_knight_grey_bg.png")
white_bishop_grey_bg_image = PhotoImage(file="chess_img/grey_bg/white_bishop_grey_bg.png")
white_king_grey_bg_image = PhotoImage(file="chess_img/grey_bg/white_king_grey_bg.png")
white_queen_grey_bg_image = PhotoImage(file="chess_img/grey_bg/white_queen_grey_bg.png")

white_bg = PhotoImage(file="chess_img/white_bg/white_bg.png")

red_pawn_white_bg_image = PhotoImage(file="chess_img/white_bg/red_pawn_white_bg.png")
red_rock_white_bg_image = PhotoImage(file="chess_img/white_bg/red_rock_white_bg.png")
red_knight_white_bg_image = PhotoImage(file="chess_img/white_bg/red_knight_white_bg.png")
red_bishop_white_bg_image = PhotoImage(file="chess_img/white_bg/red_bishop_white_bg.png")
red_king_white_bg_image = PhotoImage(file="chess_img/white_bg/red_king_white_bg.png")
red_queen_white_bg_image = PhotoImage(file="chess_img/white_bg/red_queen_white_bg.png")

red_pawn_grey_bg_image = PhotoImage(file="chess_img/grey_bg/red_pawn_grey_bg.png")
red_rock_grey_bg_image = PhotoImage(file="chess_img/grey_bg/red_rock_grey_bg.png")
red_knight_grey_bg_image = PhotoImage(file="chess_img/grey_bg/red_knight_grey_bg.png")
red_bishop_grey_bg_image = PhotoImage(file="chess_img/grey_bg/red_bishop_grey_bg.png")
red_king_grey_bg_image = PhotoImage(file="chess_img/grey_bg/red_king_grey_bg.png")
red_queen_grey_bg_image = PhotoImage(file="chess_img/grey_bg/red_queen_grey_bg.png")

grey_bg = PhotoImage(file="chess_img/grey_bg/grey_bg.png")

white_pawn_highlighted_image = PhotoImage(file="chess_img/highlighted/white_pawn_highlighted.png")
white_rock_highlighted_image = PhotoImage(file="chess_img/highlighted/white_rock_highlighted.png")
white_knight_highlighted_image = PhotoImage(file="chess_img/highlighted/white_knight_highlighted.png")
white_bishop_highlighted_image = PhotoImage(file="chess_img/highlighted/white_bishop_highlighted.png")
white_king_highlighted_image = PhotoImage(file="chess_img/highlighted/white_king_highlighted.png")
white_queen_highlighted_image = PhotoImage(file="chess_img/highlighted/white_queen_highlighted.png")

red_pawn_highlighted_image = PhotoImage(file="chess_img/highlighted/red_pawn_highlighted.png")
red_rock_highlighted_image = PhotoImage(file="chess_img/highlighted/red_rock_highlighted.png")
red_knight_highlighted_image = PhotoImage(file="chess_img/highlighted/red_knight_highlighted.png")
red_bishop_highlighted_image = PhotoImage(file="chess_img/highlighted/red_bishop_highlighted.png")
red_king_highlighted_image = PhotoImage(file="chess_img/highlighted/red_king_highlighted.png")
red_queen_highlighted_image = PhotoImage(file="chess_img/highlighted/red_queen_highlighted.png")

highlighted_bg = PhotoImage(file="chess_img/highlighted/highlighted_bg.png")
castling_highlighted_bg = PhotoImage(file="chess_img/highlighted/castling_highlighted_bg.png")

white_pawn_purple_bg_image = PhotoImage(file="chess_img/purple_bg/white_pawn_purple_bg.png")
white_rock_purple_bg_image = PhotoImage(file="chess_img/purple_bg/white_rock_purple_bg.png")
white_knight_purple_bg_image = PhotoImage(file="chess_img/purple_bg/white_knight_purple_bg.png")
white_bishop_purple_bg_image = PhotoImage(file="chess_img/purple_bg/white_bishop_purple_bg.png")
white_king_purple_bg_image = PhotoImage(file="chess_img/purple_bg/white_king_purple_bg.png")
white_queen_purple_bg_image = PhotoImage(file="chess_img/purple_bg/white_queen_purple_bg.png")

red_pawn_purple_bg_image = PhotoImage(file="chess_img/purple_bg/red_pawn_purple_bg.png")
red_rock_purple_bg_image = PhotoImage(file="chess_img/purple_bg/red_rock_purple_bg.png")
red_knight_purple_bg_image = PhotoImage(file="chess_img/purple_bg/red_knight_purple_bg.png")
red_bishop_purple_bg_image = PhotoImage(file="chess_img/purple_bg/red_bishop_purple_bg.png")
red_king_purple_bg_image = PhotoImage(file="chess_img/purple_bg/red_king_purple_bg.png")
red_queen_purple_bg_image = PhotoImage(file="chess_img/purple_bg/red_queen_purple_bg.png")

purple_bg = PhotoImage(file="chess_img/purple_bg/purple_bg.png")
...
def reset_board():
    ...
    global KING_ROCK_DIDNT_MOVE_DICT
...
def get_coords_of_figures_which_can_be_moved_to_save_king_and_their_moves_dict(king_coords):
    ...
    for element in COORDS_FIGURE_DICT:
        ...
        if COORDS_FIGURE_DICT[element][0] == king_color and COORDS_FIGURE_DICT[element][1] != "king":
            figure_moves = fnc.get_possible_moves_list(element, COORDS_FIGURE_DICT)
...
def get_king_moves_to_safety(king_coords):
    ...
    king_color = COORDS_FIGURE_DICT[king_coords][0]
    defending_king_moves = fnc.get_possible_moves_list(king_coords, COORDS_FIGURE_DICT)
...
def get_squares_attacked_by_color(color, coords_figure_dict):
    ...
    for element in coords_figure_dict:
        if coords_figure_dict[element][0] == color:
            list_of_moves = fnc.get_possible_moves_list(element, coords_figure_dict)
...
def get_all_possible_moves(coords, coords_figure_dict):
    ...
    if is_king_attacked:
        ...
        standard_moves_list = fnc.get_possible_moves_list(coords, coords_figure_dict)
...
def move_rock_if_castling(new_coords):
    ...
    standard_possible_moves_list = fnc.get_possible_moves_list(OLD_COORDS, COORDS_FIGURE_DICT)
...
def construct_buttons():
    ...
    for x in range(0, 8):
        for y in range(0, 8):
            btn = Button(my_frame, image=white_bg,
    ...
    reset_button = Button(my_frame, text="reset board", font=("Helvetica", 16), padx=20, pady=10,
                          command=reset_board)
    reset_button.grid(row=8, column=0, columnspan=3, padx=20, pady=10)

    STATUS_LABEL = Label(my_frame, text="turn: white", font=("Helvetica", 16), padx=10, pady=5)
    STATUS_LABEL.grid(row=8, column=3, columnspan=4)

    game_time = "00:00"
    TIMER_LABEL = Label(my_frame, text=game_time, font=("Helvetica", 16), padx=10, pady=5)
    TIMER_LABEL.grid(row=8, column=7)


def construct_figures():
    global COORDS_FIGURE_DICT
